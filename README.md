...
##  The Palm project overview

This palm census pipeline spans three notebooks that take raw ML detection output through geolocation, post-QA standardisation and automated blank spot generation:

| Steps | Scripts / Notebooks | Purpose |
|---|---|---|
...
Converts any / all client supplied boundary vector file into a standardised GeoJSON that the downstream census notebooks expect. Handles KMZ decompression, KML namespace parsing, Z-coordinate stripping and ring closure.
